...
export default function GoogleOAuthButton() {
  const {
    updateState,
    state,
    handleOAuthPhoneVerification: originalHandleOAuthPhoneVerification, // Renaming to avoid conflict
    confirmOAuthPhone,
  } = useAuthContext();
  ...
  useEffect(() => {
    ...
    // Removed the automatic reset of isInitiatingOAuth here.
    // We will now rely solely on explicit resets in handleGoogleAuth,
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      if (createdSessionId) {
        ...
        router.push("/home");
        toast.show("Successfully logged in with Google!", { type: "success" });
  ...
  return (
    <View>
      ...
      >
        <Image
          source={require("@/assets/icons/google.png")} // Ensure this path is correct
